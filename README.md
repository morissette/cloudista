...
- [x] **Upgrade to Python 3.12**
  - [x] `Dockerfile` base image updated to `python:3.12-slim`
  - [x] `Pipfile` `python_version` updated to `"3.12"`
  - [x] All GitHub Actions workflows updated to `python-version: "3.12"`
